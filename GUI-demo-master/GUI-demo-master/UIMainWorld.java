...
public class UIMainWorld extends World
{
    ...
    private void testActors()
    {
         ...
         */
        TextBox textbox = new TextBox("This is a text box ;)",24,true,Color.RED,Color.BLACK);
         ...
         */
        Menu menu = new Menu("File","New\nOpen\nSave\nClose\nExit",18,Color.RED,Color.BLACK,Color.BLUE,Color.MAGENTA,new FileCommands());
